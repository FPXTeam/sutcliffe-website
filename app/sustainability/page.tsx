...
export default function Sustainability(){
  ...
  <section className="sustainability-sources shell section-pad rule-top">
    ...
    <ol>
      ...
      <li id="source-mpi-forest"><b>4 · Ministry for Primary Industries</b><a href="https://www.mpi.govt.nz/forestry/new-zealand-forests-forest-industry/about-new-zealands-forests" target="_blank" rel="noopener noreferrer">About New Zealand&apos;s plantation forests ↗</a></li>
    </ol>
  </section>
