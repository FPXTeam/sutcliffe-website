...
export default function Contact(){
  ...
  <section className="contact-hero shell"><Image className="page-hero-image contact-hero-image" src="/contact-timber-desk.jpg" alt="" fill priority fetchPriority="high" sizes="100vw" /><div><p className="eyebrow light">Auckland · New Zealand</p><h1>Timber enquiries.<br/><em>Tell us the specification.</em></h1></div><div className="contact-direct"><p>Enquiries go straight to our timber team.</p><a href="mailto:sales@sutcliffetrading.com">sales@sutcliffetrading.com ↗</a><a href="tel:+642108473262">+64 21 084 73262 ↗</a></div></section>
