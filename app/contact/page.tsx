...
export default function Contact(){
  ...
  <section className="contact-hero shell"><Image className="page-hero-image contact-hero-image" src="/contact-timber-desk.jpg" alt="" fill priority fetchPriority="high" decoding="sync" sizes="100vw" /><div><p className="eyebrow light">Auckland · New Zealand</p><h1>Timber enquiries.<br/><em>Tell us the specification.</em></h1></div><div className="contact-direct"><p>Enquiries go straight to our timber team.</p><a href="mailto:sales@sutcliffetrading.com">sales@sutcliffetrading.com ↗</a><a href="tel:+642108473262">+64 21 084 73262 ↗</a></div></section>
  <section className="contact-layout shell section-pad reveal"><div><p className="eyebrow">We&apos;ll tell you what is possible</p><h2 className="display-serif">What to include in<br/>your timber enquiry.</h2><p>Include the product or grade, dimensions, volume, treatment and delivery point if you have them. If some details are still open, tell us the job and our team will help narrow the requirement.</p><Link className="text-link" href="/timber/how-to-specify-a-timber-enquiry">Read the timber enquiry guide <span>→</span></Link></div><ContactForm/></section>
