...
export default function Home() { return <main>
  ...
  <section className="closing shell"><p className="eyebrow light">Get in touch</p><h2>Tell us the specification.<br/>We&apos;ll tell you what&apos;s possible.</h2><Link className="button button-light" href="/contact">Start an enquiry</Link><img className="closing-logo" src="/brand/sutcliffe-logo-light-square.png" alt="" aria-hidden="true"/></section>
</main> }
